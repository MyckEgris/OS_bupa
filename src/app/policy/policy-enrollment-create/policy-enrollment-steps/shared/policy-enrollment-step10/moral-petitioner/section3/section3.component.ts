...
export class Section3Component implements OnInit, OnDestroy {
  ...
  /***
   * Id of the economic information petitioner section in JSON
   */
  private POLICYAPP_ECONOMIC_INFO_PETITIONER = 6;
  ...
  get formEnrollmentEconomicPetitioner() {
    return this.formEnrollmentPetitioner.get('policyAppInfoEconomicMoralPetitioner') as FormGroup;
  }
  ...
  private assignGUID() {
    if (!this.formEnrollmentEconomicPetitioner.get('guidCURP')) {
