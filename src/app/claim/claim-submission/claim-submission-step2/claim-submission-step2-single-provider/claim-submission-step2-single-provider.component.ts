/**
* Claim-submission-step2-single-provider.component.ts
*
* @description: This class shows step 2 of claim submission wizard for single provider option.
* @author Yefry Lopez.
...
/**
 * This class shows step 2 of claim submission wizard.
 */
@Component({
  selector: 'app-claim-submission-step2-single-provider',
  templateUrl: './claim-submission-step2-single-provider.component.html'
})
export class ClaimSubmissionStep2SingleProvicerComponent implements OnInit, OnDestroy {
