...
import { GeneralQuestionDetail } from 'src/app/policy/policy-enrollment-create/policy-enrollment-steps/shared/policy-enrollment-step4/shared/models/general-question-details.model';
import { QuestionDetailModelBase } from 'src/app/policy/policy-enrollment-create/policy-enrollment-steps/shared/policy-enrollment-step4/shared/models/question-detail-base.model';
import { WomenQuestionDetail } from 'src/app/policy/policy-enrollment-create/policy-enrollment-steps/shared/policy-enrollment-step4/shared/models/women-question-details.model';
import { MedicalHistoryDetailModelBase } from 'src/app/policy/policy-enrollment-create/policy-enrollment-steps/shared/policy-enrollment-step4/shared/models/medical-history-details/medical-history-base.model';
import { MedicalCheckUpQuestionDetail } from 'src/app/policy/policy-enrollment-create/policy-enrollment-steps/shared/policy-enrollment-step4/shared/models/medical-history-details/medical-check-up-details.model';
import { HabitsQuestionDetail } from 'src/app/policy/policy-enrollment-create/policy-enrollment-steps/shared/policy-enrollment-step4/shared/models/medical-history-details/habits-details.model';
import { FamilyHistoryQuestionDetail } from 'src/app/policy/policy-enrollment-create/policy-enrollment-steps/shared/policy-enrollment-step4/shared/models/medical-history-details/family-history-details.model';
