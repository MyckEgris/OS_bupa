...
import { FileUpdaloadDocuments } from './fileUpdaloadDocuments';
...
export class DialogComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const claimSubmissionFiles = this.customTypes.customTypes ? this.customTypes.customTypes : 'image:.jpeg,.jpg,.gif,.png|pdf:.pdf|code:.xml';
